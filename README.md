...
```
git clone git@github.com:KDlamini/bookstore.git
```
...
Feel free to check the [issues page](https://github.com/KDlamini/bookstore/issues).
...
- This project is part of week 3 of module 3 in the Microverse study program.
